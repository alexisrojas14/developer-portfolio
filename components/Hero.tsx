  ...
  return (
    ...
    >
      ...
      <div className="animate-fade-in-up-5 flex items-center gap-6">
        ...
        <a href={lang === "es" ? "/Hv_Alexis_Rojas_2026.pdf" : "/Resume_Alexis_Rojas_2026.pdf"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-full border border-primary/40 text-primary text-xs font-mono hover:bg-primary/10 hover:border-primary hover:drop-shadow-[0_0_8px_var(--primary)] transition-all duration-300">
          <Download size={16} />
